...
describe('GameCanvas render', () => {
  ...
  it('TestRenderDrawsSnakeSegmentsAtExpectedGridPositions', () => {
    ...
    assert(JSON.stringify(background.slice(0, 4)) === JSON.stringify([0, 0, 200, 160]))
  ...
  it('TestRenderDrawsFoodAtExpectedGridPosition', () => {
    ...
    assert(JSON.stringify(foodRect.slice(0, 4)) === JSON.stringify([101, 81, 18, 18]))
  ...
  it('TestRenderDrawsGameOverOverlayAndText', () => {
    ...
    assert(JSON.stringify(overlayRect.slice(0, 4)) === JSON.stringify([0, 0, 200, 160]))
